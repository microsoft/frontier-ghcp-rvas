# Stage 1: Technical Planning -- Backend Developer Tasks

**Time: ~1 hour setup + 30 min planning**

## Tasks

Plan to actually use the api-architect agent for the REST design judgment calls it exists for, resource shapes, status codes, and the TrailMate data model, not just to have it sit in `.github/agents/`.

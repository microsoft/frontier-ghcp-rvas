# Stage 1: Technical Planning -- QA Engineer Tasks

**Time: ~1 hour setup + 30 min planning**

## Tasks

Plan to lean on the test-engineer agent for judgment on which TrailMate flows and edge cases matter most, not just to generate boilerplate test code.

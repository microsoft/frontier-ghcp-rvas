...
|-------|------|----------|-------------|
| 1 | [Spec to Backlog](stage-1-backlog.md) | 1.5-2 hours | Build a skill that converts the spec into structured work items |
| 2 | [Technical Analysis](stage-2-analysis.md) | 1-1.5 hours | Build a skill that generates a technical analysis from spec and existing code |

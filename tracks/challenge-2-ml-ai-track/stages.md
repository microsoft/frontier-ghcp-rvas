...
|-------|------|------------|-----------|----------------|
| 1 | [Data Discovery and Cleaning](stage-1-data-discovery.md) | ⭐⭐ | 60-75 min | Data quality report documenting all 7+ issues |
| 2 | [Exploratory Analysis and Feature Engineering](stage-2-exploratory-analysis.md) | ⭐⭐ | 60-90 min | 8+ visualizations with interpretation, hypothesis tests, feature selection |
| 3 | [Model Development and Rigorous Evaluation](stage-3-model-development.md) | ⭐⭐⭐ | 60-90 min | 4+ models with pipelines, cross-validation, cost-sensitive scoring |
...
Previous: [Track Overview](../challenge-2-ml-ai-track.md) | Next: [Stage 1: Data Discovery and Cleaning](stage-1-data-discovery.md)

...
|------|-----------------|-----------------|
| [Product Owner](stage-3-sprint-2-integration/product-owner.md) | Bug triage, PR reviews, release notes, demo prep | Release notes drafted, demo outline ready |
...
| [DevOps Engineer](stage-3-sprint-2-integration/devops-engineer.md) | Reverse proxy, CI smoke tests, shareable environment | Full stack running reliably in Codespaces |
| [Business Analyst](stage-3-sprint-2-integration/business-analyst.md) | Acceptance tests, known issues doc *(optional role)* | All features validated, known issues listed |

...
Previous: [Stage 1: Discovery and Planning -- DevOps Engineer Tasks](../stage-1-discovery-planning/devops-engineer.md) | Next: [Stage 3: Sprint 2 -- DevOps Engineer Tasks](../stage-3-sprint-2-integration/devops-engineer.md)

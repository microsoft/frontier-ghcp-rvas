...
If your test agent produces generic assertions or coverage that does not map to an acceptance criterion, refine its guidance before relying on the test for the integration run.
